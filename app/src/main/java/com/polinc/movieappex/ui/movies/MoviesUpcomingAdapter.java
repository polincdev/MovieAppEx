...
public class MoviesUpcomingAdapter extends  RecyclerView.Adapter<MoviesUpcomingAdapter.ViewHolder> {
    ...
    public void setOnButtonClickListener(OnButtonClickListener listener) {
     ...
     public MoviesUpcomingAdapter(List<Movie> movies) {
         this.movies = movies;
    }
    ...
    @Override
    public MoviesUpcomingAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
         context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);

        // Inflate the custom layout
        View contactView = inflater.inflate(R.layout.item_mov_up, parent, false);
    ...
    @Override
    public void onBindViewHolder(MoviesUpcomingAdapter.ViewHolder holder, int position) {
